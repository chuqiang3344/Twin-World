...
public class HttpHelper {
    ...
    public String sendRequest(String url) {
        String html = "";
        // 搜索链接
        HttpClient httpClient = (HttpClient) HttpClientManager.getHttpClient();
        HttpResponse httpResponse = null;
        HttpEntity entity = null;
        InputStream is = null;
        HttpGet httpGet = null;
    ...
    public String sendPostRequest(String url, Map<String, String> prams) {
        ...
        HttpEntity entity = null;
        InputStream is = null;
        HttpPost hotpot = new HttpPost(url);
        ...
        try {
            ...
            hotpot.setHeader("User-Agent", userAgent);
            // httpGet.addHeader("Accept-Encoding", "gzip,deflate,sdch");//乱码
            hotpot.setHeader("Accept", "image/gif, image/jpeg, image/pjpeg, image/pjpeg, application/x-shockwave-flash, application/vnd.ms-excel, application/vnd.ms-powerpoint, application/msword, application/QVOD, application/QVOD, */*");
...
//            hotpot.setHeader("X-Requested-With", "XMLHttpRequest");
    ...
    public String sendRequest(String url, String cookie) {
        ...
        try {
            ...
            is = entity.getContent();
            ByteBuffer byteBuffer = readToByteBuffer(is, is.available());
            html = bufTransformHtml(html, charset, byteBuffer);
        } catch (Exception e) {
            logger.error("logger，searchUrl: " + url);
            logger.error(ExceptionUtils.getMessage(e));
        } finally {
...
//            httpGet.setConfig(config);
    ...
    public void colseAllStream(InputStream is) {
        if (is != null) {
            try {
                is.close();
            } catch (IOException e) {
    ...
    public void colseAllStream(InputStream is, HttpGet httpGet) {
        if (is != null) {
            try {
                is.close();
            } catch (IOException e) {
    ...
    public void colseAllStream(InputStream is, HttpEntity entity, HttpGet httpGet) {
        if (entity != null) {
            try {
    ...
    public void colseAllStream(InputStream is, HttpEntity entity, HttpPost httpGet) {
        if (entity != null) {
            try {
                entity.consumeContent();
            } catch (IOException e) {
...
//        String url3 = "http://weixin.sogoasdu.com/gzhjs?cb=sogou.weixin.gzasdhcb&openid=oIWsFt7AecfMHG2t1Eb6JIYYmP6g&eqs=kHsqoh5guuOWo5hMghaDnum0dZlLUAHfi9JCUGVEegvUx3JINBOcD7Puoyxvy9fSH6Yiq&ekv=7&page=1&t=1439949732268";
        String url4 = "http://www.yxtv.cn/portal.php?mod=list&catid=1";
        System.out.println(httpHelper.sendRequest(url4,"Bhd8_1c36_saltkey=Dj8x5SBb; Bhd8_1c36_lastvisit=1470645922; Bhd8_1c36_sendmail=1; Bhd8_1c36_sid=gMPzpK; CNZZDATA1253031319=750093396-1470646634-http%253A%252F%252Fwww.yxtv.cn%252F%7C1470646634; Bhd8_1c36_lastact=1470650788%09connect.php%09check; Bhd8_1c36_lastrequest=b315cDLbXoAent3fRZykX8UB%2Fd81lN%2BdijWDkZ1enyw63wYzXXHB"));
